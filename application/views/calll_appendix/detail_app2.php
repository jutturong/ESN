...
<tr >
  ...
  <tr>
    ...
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$date_follow_patient?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>
    ...
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$count_ep?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>

        <tr>
      <td align="right" valign="top" >ระยะเวลาที่เป็นเมื่อเทียบกับครั้งก่อน :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$compare_lasttime?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>

        <tr>
      <td align="right" valign="top" >ระดับความรุนแรงของอาการชักเมื่อเีทียบกับครั้งก่อน :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$ep_lasttime?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>
  
         <tr>
      <td align="right" valign="top" >น้ำหนัก (กิโลกรัม) :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$weight?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>
 
          <tr>
      <td align="right" valign="top" >ระดับยาในเลือด :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$medicine_level?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>

          <tr>
      <td align="right" valign="top" >ยาที่ได้รับ :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$medicine?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>

          <tr>
      <td align="right" valign="top" >ปัญหาการแพ้ยาที่เกิดขึ้น :</td>
    <td width="498" height="2">
    <input name="birthdate" type="text"  value="<?=$problem?>" id="birthdate" size="10" maxlength="15" disabled="disabled" >     </td>
  </tr>

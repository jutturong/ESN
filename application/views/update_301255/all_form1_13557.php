...
$('#noncompliance_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
              //$("#compliance_log_span").load('<?=base_url()?>index.php/loadtable/load_noncompliance/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ ของเดิม ปรับปรุง 20/3/57
                // $("#compliance_log_span").load('<?=base_url()?>index.php/loadtable/load_form_noncompliance_blank/'+  $('#HN_ep').val());   
                // $("#compliance_log_span").load('<?=base_url()?>index.php/welcome/test2/'+  $('#HN_ep').val());  	     
...
$('#adr_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
		 $("#adr_log_span").load('<?=base_url()?>index.php/loadtable/load_form_adrs_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
		 return false; 
	   }
	);
});
...
$('#other_drps_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
		// $("#other_drps_log_span").load('<?=base_url()?>index.php/loadtable/load_other_drps/'+  $('#HN_ep').val()); //ของเดิมก่อนปรับแต่ง
               $("#other_drps_log_span").load('<?=base_url()?>index.php/loadtable/load_form_other_drps_view_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ		
               return false; 
	   }
	);
});

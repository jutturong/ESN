...
<!--<button id="btn_g">Get JSON data</button>-->
 ...
 <!-- <button id="btn_graph">graph</button>-->
  ...
  //echo anchor_popup('news/local/123', 'GRAPH', $atts);
   //echo anchor_popup('../jpgraph/src/Examples/a_line02.php', 'GRAPH', $atts);
             $encodeHN=base64_encode($HN);
			//echo anchor_popup('../jpgraph/src/Examples/epi_graph.php?HN='.$HN.'', 'GRAPH', $atts);
...
<tr>
    <td colspan="2" align="left">
                                          ...
                                          <font color="#FF0000">
                                            ชักครั้งก่อน : <input name="value_epi" id="value_epi"   size="3" maxlength="3"  style="text-align:center" value="<?=@$value64?>" readonly="readonly"/>
                                            ครั้ง
                                           </font>

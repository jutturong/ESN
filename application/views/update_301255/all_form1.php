	...
	$('#call_ep').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------epilepsy clinic  tab1
	      { 
	           //$("#load_log_ep_value").load('<?=base_url()?>index.php/loadtable/load_epi/'+  $('#HN_ep').val());  //ปรับปรุง
                           $("#load_log_ep_value").load('<?=base_url()?>index.php/epi2/load_epi/'+  $('#HN_ep').val());  //ปรับปรุง		
                          return false; 
                     }
	);
					...
					//$("#load_log_eeg_value").load('<?=base_url()?>index.php/loadtable/load_eeg/'+  $('#HN_ep').val()); //function ที่ปรับปรุง
								  //===== เพิ่ม function ใหม่================
									...
									//$("#load_log_eeg_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  });
                                                                              $("#load_log_eeg_value").load('<?=base_url()?>index.php/eeg/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  });
				...
				//$("#load_image_value").load('<?=base_url()?>index.php/epi/query_imaging',{  'HN':$("#HN_ep").val() });//ของเดิม
					...
					//===== เพิ่ม function ใหม่================
				            ...
				            //	$("#load_log_image_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  });
                                                	//$("#load_log_image_value").load('<?=base_url()?>index.php/loadtable/image/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  });
                                                        $("#load_log_image_value").load('<?=base_url()?>index.php/image/loadform_image/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  });
//loadform_image				 
    return false; 
		   }
	);
		...
		$('#call_general').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	      { 
				...
				//   $("#load_log_general_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
                                                        $("#load_log_general_value").load('<?=base_url()?>index.php/general/loadform/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 				  
                                            return false; 
		   }
	);
	      ...
	      { 
				...
				//$("#load_blood_value").load('<?=base_url()?>index.php/epi/query_blood',{  'HN':$("#HN_ep").val() });//ของเดิม
								...
								//$("#load_log_blood_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
                                                                $("#load_log_blood_value").load('<?=base_url()?>index.php/blood/loadform/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
				    return false; 
		   }
	);
				  ...
				  { 
						...
						//$("#load_chem1_value").load('<?=base_url()?>index.php/epi/query_chem1',{  'HN':$("#HN_ep").val() }); //ของเดิม
										...
										//$("#load_log_chem1_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
                                                                                                                    $("#load_log_chem1_value").load('<?=base_url()?>index.php/chem1/loadform/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
							return false; 
				   }
				);
	      ...
	      { 
				...
				//$("#load_chem2_value").load('<?=base_url()?>index.php/epi/query_chem2',{  'HN':$("#HN_ep").val() }); //ของเดิม
									...
									//$("#load_log_chem2_value").load('<?=base_url()?>index.php/loadtable/load_switch/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
                                                                        $("#load_log_chem2_value").load('<?=base_url()?>index.php/chem2/loadform/',{  'HN':$('#HN_ep').val(),'link_': link_,'id_div':id_div  }); 
				    return false; 
		   }
	);
...
$('#noncompliance_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   {            	     
                  // $("#compliance_log_span").load('<?=base_url()?>index.php/loadtable_mo2/load_form_noncompliance_blank/'+  $('#HN_ep').val());               
                   $("#compliance_log_span").load('<?=base_url()?>index.php/noncompliance/load_form_noncompliance_blank/'+  $('#HN_ep').val());                            
                      return false; 
	   }
	);

$('#add_noncompliance_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
		 $("#compliance_log_span").load('<?=base_url()?>index.php/loadtable/add_data_noncompliance/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
		 return false; 
	   }
	);
...
$('#adr_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
	       // $("#adr_log_span").load('<?=base_url()?>index.php/loadtable/load_form_adrs_mo1/'+  $('#HN_ep').val()); //origin 13-5-57
                      $("#adr_log_span").load('<?=base_url()?>index.php/loadtable_mo2/load_form_adrs_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ		 
                     return false; 
	   }
	);
});
...
$('#medication_error_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
	        //$("#medication_error_log_span").load('<?=base_url()?>index.php/loadtable/load_medication_error/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
                      //$("#medication_error_log_span").load('<?=base_url()?>index.php/loadtable/load_form_medication_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ		 
                      $("#medication_error_log_span").load('<?=base_url()?>index.php/loadtable_mo2/load_form_medication_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ                  
                      return false; 
	   }
	);
});
...
$('#other_drps_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
		// $("#other_drps_log_span").load('<?=base_url()?>index.php/loadtable/load_other_drps/'+  $('#HN_ep').val()); //ของเดิมก่อนปรับแต่ง
                          //  $("#other_drps_log_span").load('<?=base_url()?>index.php/loadtable/load_form_other_drps_view_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ  ของเดิม 18-5-57		
                          $("#other_drps_log_span").load('<?=base_url()?>index.php/loadtable_mo2/load_form_other_drps_view_mo1/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
    return false; 
	   }
	);
});
...
$('#progress_note_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
                        ...
                        //$("#progress_note_log_span").load('<?=base_url()?>index.php/loadtable_mo2/load_progress_note/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ		
                       //$("#progress_note_log_span").load('<?=base_url()?>index.php/welcome/test3/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
                        $("#progress_note_log_span").load('<?=base_url()?>index.php/progressnote/load_progress_note/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ                
                         return false; 
	   }
	);
});
...
$('#give_information_button').button(  { text:true,icons:{ primary:'ui-icon-arrowrefresh-1-w' } } ).click(function()  //-------------------Imaging  tab3
	   { 
	        // $("#give_information_log_span").load('<?=base_url()?>index.php/loadtable/load_give_information/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ
                       $("#give_information_log_span").load('<?=base_url()?>index.php/giveinformation/load_give_information/'+  $('#HN_ep').val()); //ตัวอย่างสำหรับการทดสอบ                  
                       return false; 
	   }
	);
});
				...
				if( $('#HN_ep').val().length == 0 )
				{
				   $('#suggestions_ep').hide();
						     ...
						     $.ajax({
						      ...
						      // ,url:'<?=base_url()?>index.php/epi/auto_epi' //file เดิม
                                                                             ,url:'<?=base_url()?>index.php/epi_mo2/auto_epi'
						       ,data:'HN=' + $('#HN_ep').val()
...
<table width="842">
                         <tr>
                         <td><button id="call_ep">เรียก Epilepsy Clinic</button></td>
                         </tr>               
                        <tr>
                        <td>
...
<table width="842">
                         <tr>
                         <td><button id="call_eeg">เรียก EEG</button></td>
                         </tr>               
...
<table width="842">
                         <tr>
                         <td><button id="call_image">เรียก Imaging</button></td>
                         </tr>               
...
<table width="842">
                         <tr>
                         <td><button id="call_general">เรียก General</button></td>
                         </tr>               
...
<table width="842">
                         <tr>
                         <td><button id="call_blood">เรียก Blood</button></td>
                         </tr>               
...
<table width="842">
                         <tr>
                         <td><button id="call_chem1">เรียก Chem1</button></td>
                         </tr>               
...
<table width="842">
                         <tr>
                         <td><button id="call_chem2">เรียก Chem2</button></td>
                         </tr>               
...
<table>
				...
				<tr>
					<td>
						 <button id="drug_button">เรียก Drug level</button> 
...
<div id="tabs_progress_and_action">
 ...
 <div id="non_compliance">                                
    <!--<button id="noncompliance_button">ดูข้อมูล Non Compliance</button>-->
     <button id="noncompliance_button">เรียก Non Compliance</button>
    <!--<button id="add_noncompliance_button">เพิ่มข้อมูล Non Compliance</button>-->
	<br />
	<span id="compliance_log_span"></span>
	<span id="compliance_value"></span>          
</div>	
	
<div id="adr">
    <button id="adr_button">เรียก Load ADRs</button>
	<br />
...
<div id="medication_error">
    <button id="medication_error_button">เรียก Medication error</button>
	<br />
...
<div id="other_drps">
    <button id="other_drps_button">เรียก Ohter DRPs</button>
	<br />
...
<div id="progress_note">
    <button id="progress_note_button">เรียก Progress Note</button>
	<br />
...
<div id="give_information">
    <button id="give_information_button">เรียก Give Information</button>
	<br />

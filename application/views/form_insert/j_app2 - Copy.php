...
<tr >
 ...
 <!--       
	...
	<ul>
		...
		<li><a href="#tab-monitoring-2" >EEG</a></li>
		<li><a href="#tab-monitoring-3">Imaging</a></li>
	    <li><a href="#tab-monitoring-4">Other</a></li>
         <li><a href="#tab-monitoring-5">General</a></li>
          <li><a href="#tab-monitoring-6">Blood</a></li>
           <li><a href="#tab-monitoring-7">Chem.1</a></li>
            <li><a href="#tab-monitoring-8">Chem.2</a></li>
             <li><a href="#tab-monitoring-9">Drug level</a></li>
	...
	<div id="tab-monitoring-3">
    	...
    	<div id="tab-monitoring-4">
	  </div>
    	<div id="tab-monitoring-5">
	</div>
    	<div id="tab-monitoring-6">
	</div>
        	<div id="tab-monitoring-7">
	</div>
        	<div id="tab-monitoring-8">
	</div>
        	<div id="tab-monitoring-9">
	</div>

...
-->         
        ...
        &nbsp;
         ...
         <td width="683">
           <input name="date_admit" type="text" id="date_admit" size="10" maxlength="12" readonly="readonly" />          </td>
  </tr>
         ...
         <td>
           <input name="date_pay" type="text" id="date_pay" size="10" maxlength="12" readonly="readonly" />          </td>
         </tr>
         ...
         <td>
           <textarea name="preservation" cols="45" rows="1" id="preservation"></textarea>          </td>
         </tr>
         ...
         <td>
           ...
           <textarea name="detail_pay" id="detail_pay" cols="45" rows="5" disabled="disabled"></textarea>           </td>
         </tr>
         ...
         <td>
           ...
           <textarea name="other_id_type_pay" id="other_id_type_pay" cols="45" rows="1" disabled="disabled"></textarea>                 </td>
         </tr>

                     <tr>
                     <td colspan="2" align="center" valign="top">
                      <button id="save_app3">Save</button>
                      <button id="reset_app3" type="reset" >Reset</button>                      </td>
                     </tr>
</table>

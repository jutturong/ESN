...
//----------------------------------------------------------------------------
{
													...
													,listeners:{
															'select':function(e,f)
															         {
																	   // f=Ext.getCmp('detail_epilepsy_first');
																	        f='detail_epilepsy_first';
																			e=this.getValue();
																		   ks= enable_text(e,f)
																		   ks.enable();
																	 }
...
,
{  xtype:'textarea',name:'x1',width:270,height:40 ,disabled:false,value:'มีการชักกระตุกอย่างรุนแรง'}						   
//-----------------------------------------------------------------------------								   
								           ]
						        }]

...
-->
        ...
        <td colspan="2" align="center" valign="middle">
         ...
         <td width="616">
           <input name="date_ICU" type="text" id="date_ICU" size="10" maxlength="14" readonly="readonly" />
          </td>
         </tr>
         ...
         <td>
           ...
           <textarea name="detail_admit" id="detail_admit" cols="45" rows="2" disabled="disabled"></textarea>
                    </td>
         </tr>
         ...
         <td>
           <select name="id_treatment" id="id_treatment">
                     ...
                     <td colspan="2" align="center" valign="top">
                      ...
                      <button id="reset_app4" type="reset" >Reset</button>

...
-->          
    ...
    <input name="date_follow_patient" type="text"  value="<?=$date_follow_patient?>" id="date_follow_patient" size="10" maxlength="15"  >
    
    
    
    <input name="appendix" type="hidden" id="appendix" value="2" /></td>
  </tr>
    ...
    <td width="498" height="2">
    <input name="problem" type="text"  value="<?=$problem?>" id="problem" size="40" maxlength="100"  >     </td>
  </tr>

								   ...
								   onSelect:function(dateText)
			                                  { 
														...
														// var  ans= parseInt( current_year ) -  parseInt(o[2])  ;  
														 ...
														 var  ans=  parseInt( current_year ) - (parseInt(o[2]) - 543) ;
													    $('#age').val(ans);
											   }
										});
...
/*		 $('#prov_id').click(function() //select โหลดจังหวัด
		     {
				   $("#amphur").load('<?=base_url()?>index.php/home/select_amphur2',{ 'amphur_id': $(this).val() });
			 }
		   );
*/		   
...
/*		 $('#amphur').click(function()
		 {
			    $('#district_id').load('<?=base_url()?>index.php/home/select_district2',{ 'district_id': $('#amphur_id').val()  });     
		 }
		 );  
*/		 
...
<body>
     ...
     <?
	    if( strlen($amphur_id) > 0   ) //fetch อำเภอ
		{
		    @$q_am=$this->db->get_where('main_amphur',array('amphur_id'=>$amphur_id));
			foreach($q_am->result() as $row)
			{
		...
		{
		    @$q_d=$this->db->get_where('main_district',array('district_id'=>$district_id));
			foreach($q_d->result() as $row)
			{
...
-->      
       ...
       <input type="text" id="search_province" name="search_province" onblur="fill_province();" onkeyup="lookup_province(this.value);"  value="" size="15" maxlength="5"/>     
...
<!--============================= autocomplete-->
  ...
  <tr>
    ...
    <td width="609" height="2">
    <input name="birthdate" type="text"  value="<?=@$convert_birthdate?>" id="birthdate" size="10" maxlength="15"  >     </td>
  </tr>
...
<select id="current_epilepsy_id" name="current_epilepsy_id" >
    ...
    <td  width="609" height="2" align="left" valign="top">
      ...
      / วัน-เดือน-ปี 
      <input name="dmy_EEG" type="text" id="dmy_EEG" size="10" maxlength="10" readonly="readonly" value="<?=@$dmy_EEG?>" />
    ...
    <td  width="609" height="2" align="left" valign="top">
      ...
      เคย 
                  ...
                  / วัน-เดือน-ปี 
      <input name="dmy_results_EEG" type="text" id="dmy_results_EEG" size="10" maxlength="10" readonly="readonly" value="<?=@$dmy_results_EEG?>"/>
    ...
    <td  width="609" height="2" align="left" valign="top">
      ...
      เคย 
                        ...
                        / วัน-เดือน-ปี 
      <input name="dmy_ever_CT_MRI" type="text" id="dmy_ever_CT_MRI" size="10" maxlength="10" readonly="readonly" value="<?=@$dmy_ever_CT_MRI?>" />

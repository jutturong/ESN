...
<tr >
  ...
  <tr>
    ...
    <td width="588" height="2">
      <input name="age" type="text" id="age" size="4" maxlength="2" readonly="readonly" value="<?=$age?>"  />       
...
-->          
    ...
    <td width="588" height="2">
      <input name="date_pay" type="text" id="date_pay" size="10" maxlength="12"  value="<?=$date_pay?>"  />       </td>
  </tr>

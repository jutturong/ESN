...
<tr >
    ...
    <input name="appendix" type="hidden" id="appendix" value="6" />    </td>
  </tr>
...
-->          
        ...
        <tr>
      <td align="right" valign="top">วัน/เดือน/ปี  ที่เสียชีวิต :</td>
    <td width="498" height="2">
    
      <input name="date_dead" type="text" id="date_dead" size="10" maxlength="12"  value="<?=$date_dead?>"  />      
      
       </td>
  </tr>

        <tr>
      <td align="right" valign="top">สาเหตุการเสียชีวิต :</td>
    <td width="498" height="2">
      <textarea name="result_dead" cols="45" rows="2"  id="result_dead"><?=$result_dead?>    
      </textarea>
       </td>
  </tr>
